...
public class BackgroundEmergencie {
    ...
    public void backgroundEmergency() {
        ...
        Thread emergencyThread = new Thread(() -> {
            ...
            int durationMinuts = (int) durationMillis / 1000;
            int durationHours = durationMinuts / 60;
            int remainingMinuts = durationMinuts - (durationHours * 60);
            // Actualizar el tiempo de atención en la lista de tiempos generales
            if (generalTime.isEmpty()) {
                generalTime.add(0);
            }
            // Guardar el tiempo de atención en la lista de tiempos generales
            int operator = generalTime.get(0);
            int operator1= operator + durationMinuts;
            generalTime.clear();
            generalTime.add(operator1);
            // Mostrar el tiempo de atención en minutos y segundos
            System.out.println(
                    ConsoleColor.orangeText("|-La emergencia ha sido atendida en: " + durationHours + " Horas y "
                            + remainingMinuts + " Minutos"));
            System.out.println(
                    ConsoleColor.redText("|===========================================================|"));
            System.out.println(
